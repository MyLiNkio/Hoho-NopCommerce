...
namespace Nop.Plugin.Widgets.qBoSlider.Models.Admin.WidgetZones
{
    ...
    public record WidgetZoneSlideSearchModel : BaseSearchModel
    {
        ...
        /// <summary>
        /// Gets or sets targeted screen variant value
        /// </summary>
        public int TargetScreenVariant { get; set; }

        /// <summary>
        /// Gets or sets MainOrChildSlideId value
        /// </summary>
        ...
        public record SlideListItem : BaseNopEntityModel
        {
            ...
            /// <summary>
            /// Gets or sets indicator whether that slide has overrided slide for mobile creens targets
            /// </summary>
            public bool HasMobileTargetSlide { get; set; }
